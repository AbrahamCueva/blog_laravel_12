<x-layouts.app>
    <div class="mb-8 flex justify-between items-center">
        ...
        <a href="{{ route('admin.categories.create') }}" class="btn btn-green text-xs">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="flex justify-end mb-4">
            <form class="flex justify-start max-w-sm" method="GET" action="{{ route('admin.categories.index') }}">
